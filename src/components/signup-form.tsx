...
function getSignupErrorMessage(error: AuthError) {
  ...
  if (error.code === "user_already_exists" || error.code === "email_exists") {
    return "An account may already exist for this email. Try logging in or reset your password when login is available.";
  }
