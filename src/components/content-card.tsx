...
export function ContentCard({ card }: { card: ContentCardData }) {
  return <Link className="group rounded-2xl border border-[#e3e7e2] bg-white p-3 transition hover:-translate-y-1 hover:shadow-xl hover:shadow-[#334939]/10" href={card.href}>
